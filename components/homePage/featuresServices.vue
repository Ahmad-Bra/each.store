        ...
        <v-container fluid>
            <v-row>
                <v-col cols="12" sm="6" md="3" lg="3">
                    <div class="feat-box text-center py-20">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star-half-alt" role="img"
                        ...
                        <h3>High Quality</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur est molestias </p>
                    </div>
                </v-col>
                <v-col cols="12" sm="6" md="3" lg="3">
                    <div class="feat-box text-center py-20">
                ...
                <v-col cols="12" sm="6" md="3" lg="3">
                    <div class="feat-box text-center py-20">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="warehouse" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
